...
import { substract } from "../../../client/wrapper/Operations";

function Substraction({ showResult }: { showResult: (r: string) => void }) {
  ...
  const calculate = async () => {
    try {
      setErrorMessages("");
      showResult((await substract(number1, number2)).result);
    } catch (err) {
